...
public class SWWorldGenNetherMinable extends WorldGenerator
{
    ...
    public SWWorldGenNetherMinable(IBlockState state, int blockCount)
    {
        this(state, blockCount, BlockHelper.forBlock(Blocks.netherrack));
    }

    public SWWorldGenNetherMinable(IBlockState state, int blockCount, Predicate<IBlockState> p_i45631_3_)
    {
        this.oreBlock = state;
