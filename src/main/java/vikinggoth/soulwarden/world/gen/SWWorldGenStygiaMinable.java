...
public class SWWorldGenStygiaMinable extends WorldGenerator
{
    ...
    public SWWorldGenStygiaMinable(IBlockState state, int blockCount)
    {
        this(state, blockCount, BlockHelper.forBlock(BlockRegister.soulStone));
    }

    public SWWorldGenStygiaMinable(IBlockState state, int blockCount, Predicate<IBlockState> p_i45631_3_)
    {
        this.oreBlock = state;
