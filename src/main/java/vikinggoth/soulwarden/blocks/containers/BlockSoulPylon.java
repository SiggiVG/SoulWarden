...
public class BlockSoulPylon extends BlockContainer
{
    ...
    public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos) {
        ...
        for(int i = 0; i < 4; ++i) {
            ...
            if (worldIn.getBlockState(currentPos).getBlock() == ConfigBlocks.soulPylon && ((BlockSoulPylon.EnumType)worldIn.getBlockState(currentPos).getValue(VARIANT)).getMetadata() == 3)
            {
